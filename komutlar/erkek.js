...
exports.run = async (client, message, args) => {
  ...
  member.roles.add("958106881489002507"); //erkek rol id
  ...
  const embed1 = new Discord.MessageEmbed()
    .addField(
      ...
      ` Kayıt yapılan kişi: ${member.user} 
        ...
        Verilen Rol: <@&958106881489002507>
  ...
  let embed = new Discord.MessageEmbed()
    ...
    .addField(
      `1111`,
      `${member.user} adlı üyeye** <@&958106881489002507> **rolünü verip ismini**  \`${isim} \` **olarak ayarladım!`
    )
    .setFooter(message.author.tag, message.author.avatarURL)
    .setTimestamp();
